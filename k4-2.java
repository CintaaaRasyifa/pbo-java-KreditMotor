...
public class k4 {
    public static void main(String[] args) {
        ...
        int dp = 0;
        while (dp <= 0 || dp > dpMax) {
            System.out.print("Masukkan jumlah DP (maksimum " + dpMax + "): ");
            dp = scanner.nextInt();
            if (dp > dpMax) {
        ...
        int sisaHutang = hargaMotor - dp;
        int angsuranPerBulan = (int) Math.ceil((sisaHutang * (1 + bunga)) / jumlahBulan);

        System.out.println("\nSimulasi Kredit Motor:");
        System.out.println("Nama Kreditur: " + namaKreditur);
        System.out.println("Merk Motor: " + merkMotor);
        System.out.println("Harga Motor: " + hargaMotor);
        ...
        System.out.println("Total Pembayaran (Harga Motor + Total Bunga): " + (hargaMotor + (angsuranPerBulan * jumlahBulan)));
    }
}
